<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="School_Master.contact" %>
                                ...
                                <div class="col-md-7 col-md-push-1  probootstrap-animate" id="probootstrap-content">
                                    ...
                                    <div class="probootstrap-form">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="message" class="form-control" cols="30" rows="10" runat="server"></asp:TextBox>
                                             
                                        </div>
                                        <div class="form-group">
                                            <asp:Button ID="submit" class="btn btn-primary btn-lg" runat="server" Text="Send Message" />
